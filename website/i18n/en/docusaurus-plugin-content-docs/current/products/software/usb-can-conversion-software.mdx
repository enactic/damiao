...
(e.g.) if the data sent is 01 00 00 00 00 00 00 00, and the number of sends is 2, the data sent will be as shown
...
(e.g.) If the sent data is FF 00 00 00 00 00 00 00, the next sent data will be 00 01 00 00 00 00 00 00, and the next sent data will be 01 01 00 00 00 00 00 00.
