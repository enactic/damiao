...
## USB-CAN converter software
 ...
 Please refer about USB-CAN converter software<u>[here](/products/software/usb-can-conversion-software)</u>.
...
注：Other formats are serial transmission data
...
* 00 Heartbeat
* 0x01 Receive failed
* 0x11 Receive succeed
* 0x02 Transmit failed
* 0x12 transmit succeed
* 0x03 Baud rate setting failed
* 0x13 Baud rate setting succeed
